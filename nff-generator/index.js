...
// Automatically send the generated file to the IPFS service for
// uploading. In future, we might want to preview the image to the
// user before writing to IPFS/Ethereum
out.on("finish", async () => {
